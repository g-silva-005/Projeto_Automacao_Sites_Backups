...
END
          ...
          q|Q) exit ;;
		  f|F)
			echo "Escolha, por favor, uma das seguintes opcoes:"
			echo ""
			echo "1: Entrar nas opções do SElinux"
			echo "2: Entrar nas opções do Fail2Ban"
			echo "3: Fechar o programa"
			echo ""
			while true;do
			clear
			read -p ": " opcao
				...
				echo "Escolha, por favor, uma das seguintes opcoes:"
				echo ""
				echo "1: Ativar de forma permanente o modo "Enforcing""
